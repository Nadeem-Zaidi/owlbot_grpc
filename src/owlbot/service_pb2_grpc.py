...
class FileConverterStub:
    ...
    def __init__(self, channel):
        ...
        self.ConvertFile = channel.unary_unary(
                '/owlbot.FileConverter/ConvertFile',
...
def add_FileConverterServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'owlbot.FileConverter', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('owlbot.FileConverter', rpc_method_handlers)
